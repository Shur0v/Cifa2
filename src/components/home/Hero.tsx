...
const Hero = () => {
  return (
    <>
      <div className="content bg-bannerImg  w-[100%] h-[100vh] bg-cover bg-no-repeat bg-center sm:bg-cover">
        {/* --------------nav---------------- */}
       

        {/* --------------nav---------------- */}

        <div className=" pl-6 sm:pl-0 sm:left container mx-auto sm:flex sm:flex-col sm:justify-center sm:items-start flex flex-col justify-center items-center h-5/6">
